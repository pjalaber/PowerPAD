...
const double Settings::MOUSE_SPEED_MIN = 0.0;
...
const double Settings::MOUSE_ACCELERATION_MIN = 0.0;
const double Settings::MOUSE_ACCELERATION_DEFAULT = 5.0;
const double Settings::MOUSE_ACCELERATION_MAX = 10.0;

const QString Settings::MOUSE_SCROLL_SPEED_KEY = "Mouse/ScrollSpeed";
const double Settings::MOUSE_SCROLL_SPEED_MIN = 0.0;
const double Settings::MOUSE_SCROLL_SPEED_DEFAULT = 5.0;
const double Settings::MOUSE_SCROLL_SPEED_MAX = 10.0;
